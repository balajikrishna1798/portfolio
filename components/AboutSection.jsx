  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 py-8 px-4 items-center xl:gap-16 sm:px-16 sm:py-16">
        ...
        <div>
          <h2 className="mb-4 mt-5 font-bold text-4xl">About me</h2>
